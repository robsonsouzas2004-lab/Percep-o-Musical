/* Gate real do Módulo 1: o próximo módulo depende do desempenho auditivo, não só do teste teórico. */
(function(){
function m1(){try{return JSON.parse(localStorage.getItem('pm_m1_v1')||'{}')}catch(e){return {}}}
